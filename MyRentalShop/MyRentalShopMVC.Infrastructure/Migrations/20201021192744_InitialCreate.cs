        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeCustomer = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentDetailTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CVVCreditCardCode = table.Column<int>(nullable: false),
                    ValidThru = table.Column<int>(nullable: false),
                    CreditCardUserName = table.Column<string>(nullable: true),
                    CustomerId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DocumentDetailTypeId = table.Column<int>(nullable: true),
                    Nationality = table.Column<string>(nullable: true),
                    PassportNumber = table.Column<string>(nullable: true),
                    DocumentExpiryDate = table.Column<DateTime>(nullable: false),
                    DateOfBirth = table.Column<string>(nullable: true),
                    PESEL = table.Column<int>(nullable: false),
                    DrivingLicenseCategory = table.Column<string>(nullable: true),
                    CustomerId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Documents_DocumentDetailTypes_DocumentDetailTypeId",
                        column: x => x.DocumentDetailTypeId,
                        principalTable: "DocumentDetailTypes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinAgeBorrower = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_DocumentDetailTypeId",
                table: "Documents",
                column: "DocumentDetailTypeId");
